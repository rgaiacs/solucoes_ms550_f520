...
\begin{align}
    ...
    \label{eq:grad} \\
    \diver \vec{V} = \nabla \cdot \vec{V} &= \frac{1}{h_1 h_2 h_3} \left[\devp{h_2 h_3 V1}{q_1} + \devp{h_3 h_1 V_2}{q_2} + \devp{h_1 h_2 V_3}{q_3}\right],
    \label{eq:div} \\
...
\begin{questions}
    ...
    \begin{solution}
        ...
        Utilizando a express\~{a}o anterior para $\vec{e}_\rho$, $\vec{e}_\theta$ e $\vec{e}_z$ podemos escrever $\vec{i}$, $\vec{j}$ e $\vec{k}$ em fun\c{c}\~{a}o de $\vec{e}_\rho$, $\vec{e}_\theta$ e $\vec{e}_z$:
        \begin{align*}
            \vec{i} &= \vec{e}_z, \\
    ...
    \end{align*}
    \begin{solution}
        Utilizando \eqref{eq:fator_escala} vamos calcular
        \begin{align*}
    ...
    \begin{solution}
        ...
        \]
        come\c{c}amos calculando os fatores de escala:
        \begin{align*}
            h_u &= \sqrt{u^2 + v^2}, \\
            h_v &= \sqrt{u^2 + v^2}, \\
            h_z &= 1.
        \end{align*}
        Em seguida calculamos os vetores tangentes:
        \begin{align*}
        ...
        Utilizando os vetores tangentes, escrevemos $\vec{i}$, $\vec{j}$, $\vec{k}$ em fun\c{c}\~{a}o de $\vec{u}$, $\vec{v}$ e $\vec{z}$:
        \begin{align*}
            \vec{i} &= \frac{\sqrt{u^2 + v^2}}{2} \left(\vec{e}_u + \vec{e}_v\right), \\
            \vec{j} &= \frac{\sqrt{u^2 + v^2}}{2} \left(\vec{e}_u + \vec{e}_v\right), \\
            \vec{k} &= \vec{e}_z.
        \end{align*}
  
        Substituindo $\vec{i}$, $\vec{j}$ e $\vec{k}$ temos
        \begin{align*}
            \vec{r} &= \frac{1}{2} \left(u^2 - v^2\right) \frac{\sqrt{u^2 + v^2}}{2} \left(\vec{e}_u + \vec{e}_v\right) + u v \frac{\sqrt{u^2 + v^2}}{2} \left(\vec{e}_u + \vec{e}_v\right) + z \vec{e}_z \\
            &= \left(\frac{1}{4} \left(v^2 - u^2\right) + uv\right) \left(\frac{\sqrt{u^2 + v^2}}{2} \left(v \vec{e}_u + u \vec{e}_v\right)\right) + z \vec{e}_z
        \end{align*}
    ...
    \begin{solution}
        Para utilizar \eqref{eq:rot} precisamos do fator de escala e das componentes dos vetores tangentes. Primeira vamos calcular os fatores de escala:
        \begin{align*}
              h_u &= \sqrt{u^2 + v^2}, \\
              h_v &= \sqrt{v^2 + u^2}, \\
              h_z &= 1.
    ...
    \begin{parts}
        ...
        \]
        \begin{solution}
            Escrevendo $r = x \vec{i} + y \vec{j} + z \vec{k}$ em coordenadas esf\'{e}ricas temos
            \[
