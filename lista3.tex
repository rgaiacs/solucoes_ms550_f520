...
\begin{questions}
    ...
    \begin{solution}
        ...
        \end{align*}
        com $zp(z)$ e $z^{2}q(z)$ anal\'{i}ticas em $z = 0$ ($z = 0$ \'{e} ponto singular regular).
        ...
        Vemos que $p(t)$ e $q(t)$ são claramente não-analíticas em $t=0$. Para que $tp(t)$ seja anal\'{i}tica devemos ter $\sum_{n = 0}^\infty a_n / t^{n + 2} = 0$. J\'{a} para que $t^{2}q(t)$ seja anal\'{i}tica devemos ter $\sum_{n = 0}^\infty b_n / t^{n + 4} = B_2 / t^3 = 0$. Logo, $a_n = 0$, $b_n = 0$, $B_2 = 0$ e consequentemente $p(z) = A / z$ e $q(z) = B_1 / z^2$.
