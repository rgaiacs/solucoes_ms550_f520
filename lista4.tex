...
% Last Change: 05.07.12 09:54:21 PM
% 
% Authors:
...
\newcommand{\mycheader}{Lista 4 - Fun\c{c}\~{a} Gama}
...
\begin{questions}
    ...
    \begin{solution}
        ...
        \begin{align*}
            \exp (y) &= 1 / t \\
            y &= \ln \left( 1 / t \right) \\
            dy &= \frac{\left( - 1 / t^2 \right)}{1 / t} \,\mathrm{d}t = \frac{-1}{t} \,\mathrm{d}t.
        \end{align*}
    ...
    \begin{parts}
        ...
        \begin{solution}
            Fazendo $x = \exp \left( -w \right)$, temos $w = \ln \left( 1 / x \right) = - \ln \left( x \right)$ e consequentemente $dw = \frac{-1}{x} \,\mathrm{d}x = - \exp \left( w \right) dw$ que implica em $\,\mathrm{d}x = - \exp \left( -w \right) dw$. Avaliando os extremos,
            \begin{align*}
                x \to 0, w \to \infty, \\
                x \to 1, w \to 0.
            \end{align*}
            ...
            \end{align*}
            Fazendo $w \left( k + 1 \right) = t$ temos $w = t / \left( k + 1 \right)$ e consequentemente $\,\mathrm{d}t = \left( k + 1 \right) dw \to dw = \,\mathrm{d}t / \left( k + 1 \right)$. Avaliando os extremos
            \begin{align*}
                w \to 0, t \to 0, \\
                w \to \infty, t \to \infty.
            \end{align*}
            ...
            Logo,
            \begin{align*}
                - \int_0^\infty \exp \left( -t \right) \left( t / \left( k + 1 \right) \right) \left( 1 / \left( k + 1 \right) \right) \,\mathrm{d}t &= \left( -1 / \left( k + 1 \right) \right) \int_0^\infty \exp \left( -t \right) t \,\mathrm{d}t \\
    ...
    \begin{solution}
        Temos que
        \begin{align*}
            \int_{-1}^1 (1 + x)^{1/4} (1 - x)^{-1/4} \,\mathrm{d}x &= \int_0^1 2^{1/4} t^{1/4} (1 - t)^{-1/4} 2 \,\mathrm{d}t && t = (1 + x)/2 \\
