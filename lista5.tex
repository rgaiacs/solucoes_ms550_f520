...
% Last Change: 07.07.12 05:30:31 PM
% 
% Authors:
...
\begin{questions}
    ...
    \begin{parts}
        \part[P2 de 2012] $_2F_1(\alpha, \beta, \gamma; z) = (1 - z)^{\gamma - \alpha - \beta} {}_2F_1(\gamma - \alpha, \gamma - \beta, \gamma; z)$,
        \begin{solution}
            Temos que
            \begin{align*}
                I &= \,{}_2F_1(\alpha, \beta, \gamma; z) \\
                &= \frac{1}{B(\beta, \gamma - \beta)} \int_0^1 t^{\beta - 1} (1 - t)^{\gamma - \beta - 1} (1 - t z)^{-\alpha} \,\mathrm{d}t && \text{por \eqref{eq:hiperg_int}} \\
            ...
            \begin{align*}
                ...
                &= \int_0^1 \left( \frac{1 - v}{1 - vz} \right)^{\beta - 1} \left( 1 - \frac{1 - v}{1 - vz} \right)^{\gamma - \beta - 1} \left( 1 - \frac{z (1 - v)}{1 - vz} \right)^{-\alpha} \frac{1 - z}{(1 - vz)^2} \,\mathrm{d}v \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                \bigstar &= \int_0^1 t^{\beta - 1} (1 - t)^{\gamma - \beta - 1} (1 - t z)^{-\alpha} \,\mathrm{d}t \\
                &= \int_1^0 (1 - v)^{\beta - 1} v^{\gamma - \beta - 1} (1 - (1-v)z)^{-\alpha} (-\,\mathrm{d}v) \\
            ...
            \begin{align*}
                I &= {}_2F_1(\alpha, \beta, \gamma; z) \\
                &= \frac{1}{B(\gamma - \beta, \beta)} (1 - z)^{-\alpha} \int_0^1 v^{\gamma - \beta - 1} (1 - v)^{\beta - 1} \left( 1 - \frac{vz}{z - 1} \right)^{-\alpha} \,\mathrm{d}v \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                I &= \,{}_2F_1(\alpha, \beta, \gamma; z) \\
                &= \sum_{n = 0}^\infty \frac{(\alpha)_n (\beta)_n}{(\gamma)_n} \frac{z^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
                &= \sum_{n = 0}^\infty \frac{(\beta)_n (\alpha)_n}{(\gamma)_n} \frac{z^n}{n!} \\
                &= \,_2F_1(\beta, \alpha, \gamma; z) && \text{por \eqref{eq:hiperg_ser}} \\
            ...
            \begin{align*}
                ...
                &= \int_1^0 (1 - v)^{\alpha - 1} v^{\gamma - \alpha - 1} \left( 1 - (1 - v)z \right)^{-\beta} (- \,\mathrm{d}v) \\
    ...
    \begin{parts}
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                {}_2F_1(\alpha, \beta, \beta; z) &= \sum_{n = 0}^\infty \frac{(\alpha)_n (\beta)_n}{(\beta)_n} \frac{z^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                {}_2F_1(-k, 1, 1; 1 - z) &= \sum_{n = 0}^\infty \frac{(-k)_n (1)_n}{(1)_n} \frac{(1 - z)^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                ...
                &= \binom{a}{m} z^m \sum_{n = 0}^\infty \frac{(-m)_n (1)_n}{(a - m + 1)_n} \frac{(-z^{-1})^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                {}_2F_1(1, 1, 2; z) &= \sum_{n = 0}^\infty \frac{(1)_n (1)_n}{(2)_n} \frac{z^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                ...
                &= \sum_{n = 0}^\infty \frac{(1/2)_n (1)_n}{(3/2)_n} \frac{(z^2)^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                ...
                &= \sum_{n = 0}^\infty \frac{(1/2)_n (1/2)_n}{(3/2)_n} \frac{(z^2)^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                ...
                &= \sum_{n = 0}^\infty \frac{(a/2)_n (-a/2)_n}{(1/2)_n} \frac{(z^2)^n}{n!} && \text{por \eqref{eq:hiperg_ser}} \\
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                I &= \,{}_2F_1(1/2, 1/2, 1; k^2) \\
                &= \frac{1}{B(1/2,1 - 1/2)} \int_0^1 t^{1/2 - 1} (1 - t)^{1 - 1/2 - 1} (1 - tk^2)^{-1/2} \,\mathrm{d}t && \text{por \eqref{eq:hiperg_int}} \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                I &= \,{}_2F_1(-1/2, 1/2, 1; k^2) \\
                &= \frac{1}{B(1/2, 1 - 1/2)} \int_0^1 t^{1/2 - 1} (1 - t)^{1 - 1/2} (1 - k^2 t)^{1/2} \,\mathrm{d}t && \text{por \eqref{eq:hiperg_int}} \\
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                {}_1F_1(a, a - 1; z) &= \sum_{n = 0}^\infty \frac{(a)_n}{(a - 1)_n} \frac{z^n}{n!} && \text{por \eqref{eq:hiperg_con_ser}} \\
    ...
    \question[P2 de 2006, T4 de 2012, Ver exemplo 4.7 das notas de aula] Os polinômios de Hermite $H_n(z)$ podem ser escritos em termos da fun\c{c}\~{a}o hipergeom\'{e}trica confluente como
    \begin{align*}
