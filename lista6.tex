...
% Last Change: 23.05.12 09:58:06 PM
% 
...
\begin{questions}
    ...
    \begin{solution}
        Sabemos que $J_0(x)$ \'{e} solu\c{c}\~{a}o para \eqref{eq:bessel} e portanto $x J_0(x)$ tamb\'{e}m \'{e} solu\c{c}\~{a}o. Tomando $x = \exp(1/z)$ temos que
        \begin{align*}
            \frac{\mathrm{d}}{\mathrm{d}x} &= \frac{\mathrm{d}z}{\mathrm{d}x} \frac{\mathrm{d}}{\mathrm{d}z} \\
            &= \frac{-z^{2}}{\exp(1/z)} \frac{\mathrm{d}}{\mathrm{d}z}, \\
            \frac{\mathrm{d}^2}{\mathrm{d}x^2} &= \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\mathrm{d}}{\mathrm{d}x} \right) \\
            &= \frac{z^2 (2z + 1)}{\exp(2/z)} \frac{\mathrm{d}}{\mathrm{d}z} + \frac{z^4}{\exp(2/z)} \frac{\mathrm{d}^2}{\mathrm{d}z^2}.
        \end{align*}
        TODO
    \end{solution}

    \question Mostre que a solu\c{c}\~{a}\~{o} geral de
    \begin{align*}
