...
% Last Change: 24.06.12 11:54:58 AM
% 
% Authors:
...
\begin{questions}
    ...
    \question A fun\c{c}\~{a}o geratriz das fun\c{c}\~{o}es de Bessel \'{e} $g(x, t) = \exp(x (t - t^{-1}) / 2)$.
    \begin{parts}
    ...
    \begin{solution}
        ...
        E as fun\c{c}\~{o}es de Bessel modificada de primeira esp\'{e}cie  % TODO Completar frase.
        % TODO Procurar uma maneira mais adequada para o gr\'{a}fico abaixo.
        \begin{center}
            \begin{tikzpicture}
                \draw[->] (-1,0) -- (10,0);
