...
% Last Change: 14.07.12 10:33:45 AM
% 
% Authors:
...
\begin{align}
    ...
    & J_\nu(x) = \sum_{k = 0}^\infty \frac{(-1)^k}{k! \Gamma(k + \nu + 1)} \left( \frac{x}{2} \right)^{2k + \nu} \tag{RSFB} \label{eq:bessel_pri_esp} \\
    & J_\nu(x) = \frac{x^\nu \exp(-i x)}{2^\nu \Gamma(\nu + 1)} \,_1F_1(\nu + 1/2, 2\nu + 1; 2 i x) \tag{RHFB} \label{eq:bessel_pri_esp_hiperg_con} \\
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                I &= \frac{\mathrm{d}}{\mathrm{d}x} \left[ x^\nu J_\nu(x) \right] \\
    ...
    \question[T5 de 2012, E de 2012] A fun\c{c}\~{a}o geratriz das fun\c{c}\~{o}es de Bessel \'{e} $g(x, t) = \exp(x (t - t^{-1}) / 2)$.
    \begin{parts}
        \part Use-a para mostrar que $J_n(u + v) = \sum_{m = -\infty}^\infty J_m(u) J_{n - m}(v)$.
        \begin{solution}
            Temos que
            \begin{align*}
                \exp\left( (u + v) (t + t^{-1}) / 2 \right) &= \exp\left( u (t + t^{-1}) / 2 \right) \exp\left( v (t + t^{-1}) / 2 \right) \\
                \sum_{n = -\infty}^\infty J_n(u + v) t^n &= \sum_{m = -\infty}^\infty J_m(u) t^m \sum_{k = -\infty}^\infty J_k(v) t^k \\
                \sum_{n = -\infty}^\infty J_n(u + v) t^n &= \sum_{m = -\infty}^\infty \sum_{k = -\infty}^\infty J_m(u) J_k(v) t^{m + k} \\
                &= \sum_{n = -\infty}^\infty \left( \sum_{m = -\infty}^\infty J_m(u) J_{n - m}(v) \right) t^n && m + k = n.
            \end{align*}
            Pela \'{u}tima equa\c{c}\~{a}o conclu\'{i}mos que$J_n(u + v) = \sum_{m = -\infty}^\infty J_m(u) J_{n - m}(v)$.
        \end{solution}

        \part Mostre que $| J_0(x) | \leq 1$ e que $| J_n(x) | \leq 2^{-1/2}$ para $n = 1, 2, 3, \ldots$.
        \begin{solution}
            Tomando $n = 0$, $u = -v = x$ temos que
            \begin{align*}
                J_0(0) &= \sum_{m = -\times}^\infty J_m(x) J_{-m}(-x) \\
                &= \sum_{m = -\infty}^\infty J_m(x) (-1)^m J_m(-x) && \text{por \eqref{eq:bessel_prim_esp_neg}} \\
                &= \sum_{m = -\infty}^\infty J_m(x) (-1)^m (-1)^m J_m(x) \\
                &= \sum_{m = -\infty}^\infty J_m^2(x) \\
                &= J_0^2(x) + \sum_{m = -\infty}^{-1} J_m^2(x) + \sum_{m = 1}^\infty J_m^2(x) \\
                &= J_0^2(x) + 2 \sum_{m = 1}^\infty J_m^2(x).
            \end{align*}
            Pela defini\c{c}\~{a}o de $J_m(x)$ temos que $J_0(0) = 1$ e portanto
            \begin{align*}
                1 &= J_0^2(x) + 2 \sum_{m = 1}^\infty J_m^2(x)
            \end{align*}
            que implica em
            \begin{align*}
                \begin{cases}
                    J_0^2(x) \leq 1, \\
                    2 J_m^2(x) \leq 1, & m = 1, 2, \ldots.
                \end{cases}
            \end{align*}
        \end{solution}
    \end{parts}

    \question[P2 de 2012] Sejam $J_m(x)$ as fun\c{c}\~{o}es de Bessel de primeira esp\'{e}cie e ordem $m$. Mostre que
    \begin{parts}
        \part $\int_0^\infty J_{2n + 1}(\alpha x) \,\mathrm{d}x = a^{-1}, n = 0, 1, 2, \ldots$
        \begin{solution}
            Utilizando a rela\c{c}\~{a}o
            \begin{align*}
                J_{\nu - 1}(x) - J_{\nu + 1}(x) = 2 J'_\nu(x)
            \end{align*}
            temos, para $\nu \neq 0$, que
            \begin{align*}
                I &= \int_0^\infty J_{\nu + 1}(x) \,\mathrm{d}x - \int_0^\infty J_{\nu + 1}(x) \,\mathrm{d}x \\
                &= 2 \int_0^\infty J'_\nu(x) \,\mathrm{d}x \\
                &= 2 \left. \left[ J\nu(x) \right] \right|_0^\infty \\
                &= 0 - 0 \\
                & 0.
            \end{align*}
            Portanto,
            ...
            \begin{align*}
                \int_0^\infty J_{2n + 1}(x) \,\mathrm{d}x = \int_{0}^\infty J_{2n - 1}(x) \,\mathrm{d}x = \ldots \int_0^\infty J_1(x) \,\mathrm{d}x.
            \end{align*}
            Mas
            \begin{align*}
                \frac{\mathrm{d}}{\mathrm{d}x}\left( x^{-\nu} J_\nu(x) \right) = - x^{-\nu} J_{\nu + 1}(x) \Rightarrow \frac{\mathrm{d}}{\mathrm{d}x}\left( J_0(x) \right) = - J_1(x)
            \end{align*}
            de modo que
            \begin{align*}
                \int_0^\infty J_1(x) \,\mathrm{d}x &= - \int_0^\infty \frac{\mathrm{d}}{\mathrm{d}x}J_0(x) \,\mathrm{d}x \\
                &= \left. - J_0(x) \right|_0^\infty \\
                &= 0 - \left( - J_0(0) \right) \\
                &= 1
            \end{align*}
            e portanto
            \begin{align*}
                \int_0^\infty J_{2n + 1}(x) \,\mathrm{d}x &= 1, n = 0, 1, 2, \ldots
            \end{align*}
        \end{solution}

        \part $\int_0^\infty \frac{J_{2n}(x)}{x} \,\mathrm{d}x = (2n)^{-1}, n = 1, 2, \ldots$
        \begin{solution}
            Utilizando a rela\c{c}\~{a}o
            \begin{align*}
                \frac{2 \nu}{x} J_\nu(x) &= J_{\nu + 1}(x) + J_{\nu - 1}(x)
            ...
            temos, para $\nu = 2n$, que
            \begin{align*}
                I &= 2 \left( 2n \right) \int_0^\infty J_{2n}(x) x^{-1} \,\mathrm{d}x \\
                &= \int_{0}^\infty J_{2n + 1}(x) \,\mathrm{d}x + \int_0^\infty J_{2n - 1}(x) \,\mathrm{d}x \\
                &= 1 + 1 \\
                &= 2
            \end{align*}
            e portanto
            \begin{align*}
                \int_0^\infty J_{2n}(x) x^{-1} \,\mathrm{d}x &= (2n)^{-1}, n = 1, 2, \ldots
            \end{align*}
        \end{solution}
    \end{parts}
    ...
    \begin{solution}
        ...
        % TODO Procurar uma maneira mais adequada para o gr\'{a}fico abaixo.
        \begin{center}
            \begin{tikzpicture}
                \draw[->] (-1,0) -- (10,0);
                \draw[->] (0,-2) -- (0,4);

                \draw[domain=1:10] plot(\x - 1, {8 * sin( (\x) r) / (\x + 1)}) node[below right]{$J_0(x)$};
                \draw[domain=0:9] plot(\x, {6 * sin(\x r) / (\x + 1)}) node[above right]{$J_1(x)$};
                \draw[domain=0:9] plot(\x, {4 * sin(.7 * \x r) / (\x + 1)}) node[right]{$J_2(x)$};
            \end{tikzpicture}
        \end{center}

        A fun\c{c}\~{a}o de Bessel modificada de primeira esp\'{e}cie e ordem $\nu$ corresponde a $i^{-\nu} J_\nu(i x)$ e o esbo\c{c}o do gr\'{a}fico das fun\c{c}\~{o}es de Bessel modificada de primeira esp\'{e}cie de ordem zero, um e dois encontra-se abaixo.
        % TODO Procurar uma maneira mais adequada para o gr\'{a}fico abaixo.
        \begin{center}
            \begin{tikzpicture}
                \draw[->] (-1,0) -- (10,0);
                ...
                \draw[domain=0:10] plot(\x, {exp(\x / 4) / 2}) node[left]{$I_0(x)$};
                \draw[domain=0:10] plot(\x, {(exp(\x / 4.1) - 1) / 2}) node[above right]{$I_1(x)$};
                \draw[domain=0:10] plot(\x, {(exp(\x / 5) - 1) / 2}) node[right]{$I_2(x)$};
            \end{tikzpicture}
        \end{center}
    \end{solution}
\end{questions}
