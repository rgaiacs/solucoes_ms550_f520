...
% Last Change: 24.06.12 11:58:23 AM
% 
% Authors:
...
\begin{questions}
    ...
    \begin{solution}
        ...
        \end{align}
        % TODO Escrever a demonstra\c{c}\~{a}o da rela\c{c}\~{a}o acima.
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \end{align*}
            % TODO Demonstrar a equa\c{c}\~{a}o acima.
        \end{solution}
    ...
    \begin{parts}
        \part $P'_{2n}(0) = 0$ e $P'_{2n + 1}(0) = (-1)^n \left[ (2n + 1)! \right] / \left[ 2^{2n} (n!)^2 \right]$, $n = 0, 1, 2, \ldots$
        \begin{solution}
            Por \eqref{eq:legendre_funcao_geratriz} e \eqref{eq:legendre_funcao_geratriz_serie} temos que
            \begin{align*}
                \sum_{k = 0}^\infty P_k(x) t^k &= \frac{1}{\sqrt{1 - 2 x t + t^2}}.
            \end{align*}
            Derivando a equa\c{c}\~{a}o acima em rela\c{c}\~{a}o a $x$ obtemos
            \begin{align*}
                \sum_{k = 0}^\infty P'_k(x) t^k &= \frac{t}{\left[ 1 - 2 x t + t^2 \right]^{3/2}}.
            \end{align*}
            Fazendo $x = 0$ na equa\c{c}\~{a}o acima temos
            \begin{align*}
                \sum_{k = 0}^\infty P'_k(0) t^k &= \frac{t}{\left[ 1 + t^2 \right]^{3/2}} \\
                &= t \left[ 1 + t^2 \right]^{-3/2} \\
                &= t \sum_{n = 0}^\infty \frac{(3/2)_n}{n!} \left( -t^2 \right)^n && \text{por \eqref{eq:newton_binom_with_poch}} \\
                &= t \sum_{n = 0}^\infty \frac{(3/2)_n}{n!} (-1)^n t^{2n} \\
                &= \sum_{n = 0}^\infty \frac{(3/2)_n}{n!} (-1)^n t^{2n + 1}.
            \end{align*}
            Comparando termo a termo a equa\c{c}\~{a}o acima concluimos que
            \begin{align*}
                P'_{2n}(0) &= 0, \\
                P'_{2n + 1}(0) &= (-1)^n \frac{(3/2)_n}{n!}.
            \end{align*}
            Mas
            \begin{align*}
                \left( \frac{3}{2} \right)_n &= \frac{3}{2} \frac{5}{2} \ldots \left( \frac{2}{2} + n - 1 \right) \\
                &= \frac{1}{2^n} \frac{(2 \cdot 3) (4 \ldots 5) \left( (2n) (2n + 1) \right)}{2 \cdot 4 \ldots 2n} \\
                &= \frac{1}{2^{2n}} \frac{(2n + 1)!}{n!}.
            \end{align*}
            Portanto, $P'_{2n}(0) = 0$ e $P'_{2n + 1}(0) = (-1)^n \left[ (2n + 1)! \right] / \left[ 2^{2n} (n!)^2 \right]$, $n = 0, 1, 2, \ldots$.
        \end{solution}

        \part $\int_{-1}^1 x^2 P_{n + 1}(x) P_{n - 1}(x) \,\mathrm{d}x = \left[ 2n (n + 1) \right] / \left[ \left( 4 n^2 - 1 \right) \left( 2 n + 3 \right) \right]$, $n = 1, 2, \ldots$
        \begin{solution}
            Temos que
            \begin{align*}
                I &= \int_{-1}^1 x^2 P_{n + 1}(x) P_{n - 1}(x) \,\mathrm{d}x \\
                &= \int_{-1}^1 \left[ x P_{n + 1}(x) \right] \left[ x P_{n - 1}(x) \right] \,\mathrm{d}x \\
                &= \int_{-1}^1 \left[ \frac{(n + 2)}{(2n + 3)} P_{n + 2}(x) + \frac{(n + 1)}{(2n + 3)} P_n(x) \right] \left[ \frac{1}{(2n - 1)} P_{n}(x) + \frac{(n - 1)}{(2n - 1)} P_{n - 2}(x) \right] \,\mathrm{d}x \\
                \begin{split}
                    &= \frac{(n + 2) n}{(2n + 2) (2n - 1)} \int_{-1}^1 P_{n + 2}(x) P_{n}(x) \,\mathrm{d}x + \frac{(n + 2) (n - 1)}{(2n + 3) (2n + 1)} \int_{-1}^1 P_{n + 2}(x) P_{n - 2}(x) \,\mathrm{d}x \\
                    &\quad {}+ \frac{n (n + 1)}{(2 n + 3) (2n - 1)} \int_{-1}^1 P_n(x) P_n(x) \,\mathrm{d}x + \frac{(n + 1) (n - 1)}{(2n + 3) (2n - 1)} \int_{-1}^1 P_n(x) P_{n - 2}(x) \,\mathrm{d}x
                \end{split} \\
                \begin{split}
                    &= \frac{(n + 2) n}{(2n + 2) (2n - 1)} 0 + \frac{(n + 2) (n - 1)}{(2n + 3) (2n + 1)} 0 \\
                    &\quad {}+ \frac{n (n + 1)}{(2 n + 3) (2n - 1)} \frac{2}{2n + 1} + \frac{(n + 1) (n - 1)}{(2n + 3) (2n - 1)} 0
                \end{split} \\
                &= \frac{n (n + 1)}{(2 n + 3) (2n - 1)} \frac{2}{2n + 1}  \\
                &= \frac{2 n (n + 1)}{(2n + 3) (4n^2 - 1)},
            \end{align*}
            onde a terceira igualdade decorre de \eqref{eq:legendre_rel_rec_2n+1}.
        \end{solution}
    \end{parts}
\end{questions}
