...
% Last Change: 06.06.12 09:44:25 PM
% 
% Authors:
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            Temos que
            \begin{align*}
                \int_0^1 P_{n}(x) \,\mathrm{d}x &= \int_0^1 \left[ \frac{P'_{2n + 1}(x) - P'_{2n - 1}(x)}{2 (2n) + 1} \right] \,\mathrm{d}x \\
                &= \frac{1}{4 n + 1} \left[ \left. P_{2n + 1}(x) \right|_0^1 - \left. P_{2n - 1}(x) \right|_0^1 \right] \\
                &= \frac{1}{(4n + 1)} \left[ P_{2n + 1}(1) - P_{2n _ 1}(0) - P_{2n - 1}(1) + P_{2n - 1}(0) \right] \\
                &= \frac{1}{(4n + 1)} \left[ - P_{2n _ 1}(0) + P_{2n - 1}(0) \right] \\
